      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:ml-6 md:flex md:items-center md:space-x-6">
            <Link 
              to="/" 
              className="text-green-700 hover:text-green-900 px-3 py-2 rounded-md text-lg font-medium transition-colors"
            >
              Home
            </Link>
            ...
            {!isAuth ? (
              ...
              <>
                ...
                <Link
                  to={`/@${authUser?.name}`}
                  className="flex items-center space-x-2 bg-green-100 text-green-800 px-4 py-2 rounded-full hover:bg-green-200 transition-colors"
                >
